package com.golive.godrive.btppublic.viewmodel.aoutbdeliveryaddress2type
...
/*
 * Represents View model for AOutbDeliveryAddress2Type
 *
 ...
 */
class AOutbDeliveryAddress2TypeViewModel(application: Application): EntityViewModel<AOutbDeliveryAddress2Type>(application, EntitySets.aOutbDeliveryAddress2, AOutbDeliveryAddress2Type.deliveryDocument) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AOutbDeliveryAddress2Type>(application, EntitySets.aOutbDeliveryAddress2, AOutbDeliveryAddress2Type.deliveryDocument, navigationPropertyName, entityData)
    }
}
