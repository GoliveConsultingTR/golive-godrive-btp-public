package com.golive.godrive.btppublic.viewmodel.aoutbdeliveryitemtype
...
/*
 * Represents View model for AOutbDeliveryItemType
 *
 ...
 */
class AOutbDeliveryItemTypeViewModel(application: Application): EntityViewModel<AOutbDeliveryItemType>(application, EntitySets.aOutbDeliveryItem, AOutbDeliveryItemType.actualDeliveredQtyInBaseUnit) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AOutbDeliveryItemType>(application, EntitySets.aOutbDeliveryItem, AOutbDeliveryItemType.actualDeliveredQtyInBaseUnit, navigationPropertyName, entityData)
    }
}
