 ...
 * - [ASerialNmbrDeliveryCreateFragment]: to create or edit a(n) ASerialNmbrDeliveryType,
 * - [ASerialNmbrDeliveryDetailFragment]: to display the details of a(n) ASerialNmbrDeliveryType,
 * - [ASerialNmbrDeliveryListFragment]: to list ASerialNmbrDelivery.
 *
 ...
 * what to do.
 */
class ASerialNmbrDeliveryActivity : AppCompatActivity(), InterfacedFragment.InterfacedFragmentListener<ASerialNmbrDeliveryType> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, ASerialNmbrDeliveryListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit()
        } else {
    ...
    override fun onFragmentStateChange(evt: Int, entity: ASerialNmbrDeliveryType?) {
        when (evt) {
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ASerialNmbrDeliveryCreateFragment}.
     */
    ...
    private fun onItemClicked(entity: ASerialNmbrDeliveryType?) {
        if (!isMasterDetailView) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, ASerialNmbrDeliveryDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if (detail == null) {
                if (entity != null)
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.detailFrame, ASerialNmbrDeliveryDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                        .commit()
            } else {
                if( entity == null) {
    ...
    private fun onCreateNewItem() {
        ...
        val fragment = ASerialNmbrDeliveryCreateFragment()
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onEditItem(entity: ASerialNmbrDeliveryType?) {
        val updateFragment = ASerialNmbrDeliveryCreateFragment()
        val arguments = Bundle()
    ...
    internal class ConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button) { _, _ ->
                (fragmentActivity as ASerialNmbrDeliveryActivity).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null)
            }
    ...
    internal class DeleteConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val fragmentActivity = requireActivity() as AppCompatActivity
            val builder = MaterialAlertDialogBuilder(fragmentActivity, R.style.AlertDialogStyle)
            val viewModel = ViewModelProvider(fragmentActivity)[ASerialNmbrDeliveryTypeViewModel::class.java]
