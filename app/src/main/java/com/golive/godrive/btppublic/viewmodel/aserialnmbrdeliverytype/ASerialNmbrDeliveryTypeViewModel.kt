package com.golive.godrive.btppublic.viewmodel.aserialnmbrdeliverytype
...
/*
 * Represents View model for ASerialNmbrDeliveryType
 *
 ...
 */
class ASerialNmbrDeliveryTypeViewModel(application: Application): EntityViewModel<ASerialNmbrDeliveryType>(application, EntitySets.aSerialNmbrDelivery, ASerialNmbrDeliveryType.maintenanceItemObjectList) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ASerialNmbrDeliveryType>(application, EntitySets.aSerialNmbrDelivery, ASerialNmbrDeliveryType.maintenanceItemObjectList, navigationPropertyName, entityData)
    }
}
