package com.golive.godrive.btppublic.viewmodel.ahandlingunititemdeliverytype
...
/*
 * Represents View model for AHandlingUnitItemDeliveryType
 *
 ...
 */
class AHandlingUnitItemDeliveryTypeViewModel(application: Application): EntityViewModel<AHandlingUnitItemDeliveryType>(application, EntitySets.aHandlingUnitItemDelivery, AHandlingUnitItemDeliveryType.handlingUnitInternalID) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AHandlingUnitItemDeliveryType>(application, EntitySets.aHandlingUnitItemDelivery, AHandlingUnitItemDeliveryType.handlingUnitInternalID, navigationPropertyName, entityData)
    }
}
