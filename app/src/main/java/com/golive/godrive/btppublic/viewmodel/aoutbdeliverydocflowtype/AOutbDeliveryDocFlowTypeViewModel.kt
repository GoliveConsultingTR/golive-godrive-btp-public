package com.golive.godrive.btppublic.viewmodel.aoutbdeliverydocflowtype
...
/*
 * Represents View model for AOutbDeliveryDocFlowType
 *
 ...
 */
class AOutbDeliveryDocFlowTypeViewModel(application: Application): EntityViewModel<AOutbDeliveryDocFlowType>(application, EntitySets.aOutbDeliveryDocFlow, AOutbDeliveryDocFlowType.precedingDocument) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AOutbDeliveryDocFlowType>(application, EntitySets.aOutbDeliveryDocFlow, AOutbDeliveryDocFlowType.precedingDocument, navigationPropertyName, entityData)
    }
}
