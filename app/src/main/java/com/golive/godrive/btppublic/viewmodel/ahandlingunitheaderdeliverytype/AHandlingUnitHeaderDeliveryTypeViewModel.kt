package com.golive.godrive.btppublic.viewmodel.ahandlingunitheaderdeliverytype
...
/*
 * Represents View model for AHandlingUnitHeaderDeliveryType
 *
 ...
 */
class AHandlingUnitHeaderDeliveryTypeViewModel(application: Application): EntityViewModel<AHandlingUnitHeaderDeliveryType>(application, EntitySets.aHandlingUnitHeaderDelivery, AHandlingUnitHeaderDeliveryType.handlingUnitInternalID) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AHandlingUnitHeaderDeliveryType>(application, EntitySets.aHandlingUnitHeaderDelivery, AHandlingUnitHeaderDeliveryType.handlingUnitInternalID, navigationPropertyName, entityData)
    }
}
