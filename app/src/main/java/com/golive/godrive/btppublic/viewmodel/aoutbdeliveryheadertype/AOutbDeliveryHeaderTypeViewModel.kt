package com.golive.godrive.btppublic.viewmodel.aoutbdeliveryheadertype
...
/*
 * Represents View model for AOutbDeliveryHeaderType
 *
 ...
 */
class AOutbDeliveryHeaderTypeViewModel(application: Application): EntityViewModel<AOutbDeliveryHeaderType>(application, EntitySets.aOutbDeliveryHeader, AOutbDeliveryHeaderType.actualDeliveryRoute) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AOutbDeliveryHeaderType>(application, EntitySets.aOutbDeliveryHeader, AOutbDeliveryHeaderType.actualDeliveryRoute, navigationPropertyName, entityData)
    }
}
