package com.golive.godrive.btppublic.viewmodel.aoutbdeliveryaddresstype
...
/*
 * Represents View model for AOutbDeliveryAddressType
 *
 ...
 */
class AOutbDeliveryAddressTypeViewModel(application: Application): EntityViewModel<AOutbDeliveryAddressType>(application, EntitySets.aOutbDeliveryAddress, AOutbDeliveryAddressType.addressID) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AOutbDeliveryAddressType>(application, EntitySets.aOutbDeliveryAddress, AOutbDeliveryAddressType.addressID, navigationPropertyName, entityData)
    }
}
